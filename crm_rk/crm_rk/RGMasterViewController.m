...
- (void)insertNewObject:(id)sender
{
    ...
    NSEntityDescription *descr = [NSEntityDescription entityForName:@"Client" inManagedObjectContext:context];
    Client *client = [[Client alloc] initWithEntity:descr insertIntoManagedObjectContext:context];
    client.country = @"Bavaria";
    client.name = @"BASF";
    client.clientId = @1003;
